export class PrivateIncomeLevel {
  constructor (
    zeroTo48000,
    thirtyThousandAndOneTo75000,
    thirtyThousandAndOneTo48000,
    seventyFiveThousandPlus,
    zeroTo30000,
    seventyFiveThousandAndOneTo110000,
    fortyEightThousandAndOneTo75000,
    hundredAndTenTousandAndOnePlus
  ) {
    ...
    this.seventyFiveThousandAndOneTo110000 = seventyFiveThousandAndOneTo110000
